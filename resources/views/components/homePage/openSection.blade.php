...
{{-- Success message toast after adding kebab to shopping cart --}}
    ...
    <div class="text-center mt-5 lg:pr-10">
        ...
        <p class="mt-6 text-4xl text-red-600 font-bold relative one"><span>MŪSŲ SKANIAUSIEJI KEBABAI</span>
            <span class="absolute -bottom-1 left-0 w-0 transition-all h-1 bg-red-600 mb-2"></span>
        </p>
        <a href="/meniu">
