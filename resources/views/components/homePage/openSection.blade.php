...
{{-- Success message toast after adding kebab to shopping cart --}}
    ...
    <div class="text-center mt-5 lg:pr-10">
        ...
        <p class="mt-6 text-4xl text-white font-bold relative one"><span>MŪSŲ SKANIAUSIEJI KEBABAI</span>
            <span class="absolute -bottom-1 left-0 w-0 transition-all h-1 bg-red-400 mb-2"></span>
        </p>
        <a href="/meniu">
